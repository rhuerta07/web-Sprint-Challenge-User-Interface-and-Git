...
Semantic HTML is HTML that has a pre-prescribed meaning.

2. Name two big differences between ```display: block;``` and ```display: inline;```.
block allows to control width and height while inline does not.
...
5. Explain why git is valuable to a team of developers.
 Allows for teams to keep track of changes and by whom.
